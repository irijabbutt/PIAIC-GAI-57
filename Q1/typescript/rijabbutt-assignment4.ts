...
let num1: number, num2: number; // Assign integer values and perform arithmetic operations.
num1 = 5;
num2 = 9;
let sum = num1 + num2;
let diff = num1 - num2;
...
if (ans == 0) console.log("9. \t", num1 + " is even.");
else console.log("9. \t", num1 + " is odd.");
...
if (age1 >= 18)
	...
	console.log(
		"10. \t",
		"Age: ",
		age1 + "\tThe person is not eligible to vote."
	);
// 11. Grading System
...
score = 87;
if (score >= 90) console.log("11. \t Grade: A");
else if (score >= 80) console.log("11. \t Grade: B");
else if (score >= 70) console.log("11. \t Grade: C");
else if (score >= 60) console.log("11. \t Grade: D");
else console.log("11. \t Grade: F");
...
m = 3;
z = 14;
if (v > m && v > z) console.log("12. \t The maximum value is " + v + ".");
else if (m > v && m > z) console.log("12. \t The maximum value is " + m + ".");
else console.log("12. \t The maximum value is " + z + ".");
...
number = 6;
if (number < 0) console.log(`15. \t The number ${number} is negative.`);
else if (number > 0) console.log(`15. \t The number ${number} is positive.`);
else if (number == 0)
	console.log(`15. \t The number ${number} is equal to zero.`);
else console.log("Error"); //  if none of them are true then prints Error
