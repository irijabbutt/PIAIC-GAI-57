...
let nam_e = "Rijab Butt";
let age = 21;
let intro = `Hi, this is ${nam_e}. I'm ${age} years old, studying Generative AI from PIAIC Lahore.`;
console.log("2- ", intro);
// Initialize a constant with a type annotation for your current mood as a boolean.
const current_mood = "Happy";
console.log("3- ", current_mood, true);
...
let user_age = "21";
console.log("5- ", user_age);
// Use a template string to display a product name and its price.
let product_name = "Klean Beauty Gel Facewash";
let price = "800Rs";
let info = `Product: ${product_name}\n    Price: ${price}`;
console.log("6- ", info);
